...
function buildZones() {
  ...
  add('A棟', 278, 636, 810, 126);
  add('B棟', 850, 350, 172, 238);
  add('C棟', 88, 420, 182, 342);
  add('後北棟', 232, 172, 382, 102);
  add('前北棟', 600, 234, 288, 96);
  add('操場', 398, 404, 336, 104);
  add('籃球場', 242, 410, 112, 142);
  add('活動中心', 1078, 304, 82, 216);
  add('廚房', 920, 196, 126, 92);
  return zones;
}
